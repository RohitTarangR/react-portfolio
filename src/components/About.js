          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            <div className="flex flex-col">
              ...
              <p className="mb-8">
                ...
                Numquam, et. Necessitatibus quam dolorum sit dolor sint
                aspernatur optio nisi itaque? <br />
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque, cumque.
              </p>
            </div>
            <button className='btn btn-md bg-accent hover:bg-accent-hover transition-all duration-300'>Contact me</button>
          </div>
        </div>
      </div>
    </section>
